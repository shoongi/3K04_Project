...
def open_VOOR(prev_page):
    ...
    reaction_entry.pack(pady=8, padx=10)
    ...
    recovery_entry.pack(pady=8, padx=10)
    ...
    save_button_recovery.pack(pady=10, padx=10)
