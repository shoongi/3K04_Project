...
void VOO_step(void)
{
  ...
  MW_digitalIO_write(VOO_DW.obj_l0.MW_DIGITALIO_HANDLE, true);
  ...
  MW_digitalIO_write(VOO_DW.obj_l.MW_DIGITALIO_HANDLE, false);

  /* MATLABSystem: '<Root>/Digital Write6' */
  MW_digitalIO_write(VOO_DW.obj.MW_DIGITALIO_HANDLE, rtb_PACE_CHARGE_CTRL);
...
{
  {
    ...
    VOO_DW.obj_l0.matlabCodegenIsDeleted = true;
    VOO_DW.obj_l0.isInitialized = 0;
    VOO_DW.obj_l0.matlabCodegenIsDeleted = false;
    obj = &VOO_DW.obj_l0;
    VOO_DW.obj_l0.isSetupComplete = false;
    VOO_DW.obj_l0.isInitialized = 1;
    obj->MW_DIGITALIO_HANDLE = MW_digitalIO_open(10U, 1);
    VOO_DW.obj_l0.isSetupComplete = true;
...
void VOO_terminate(void)
{
  ...
  if (!VOO_DW.obj_l0.matlabCodegenIsDeleted) {
    VOO_DW.obj_l0.matlabCodegenIsDeleted = true;
    if ((VOO_DW.obj_l0.isInitialized == 1) && VOO_DW.obj_l0.isSetupComplete) {
      MW_digitalIO_close(VOO_DW.obj_l0.MW_DIGITALIO_HANDLE);
    }
  }
